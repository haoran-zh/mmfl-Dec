...
if __name__=="__main__":
    ...
    for round in range(num_round):
        ...
        print('chosen cl', chosen_clients)
        # training
        print('classes size', tasks_data_info[i][5])
