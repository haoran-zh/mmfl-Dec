# language tools for shakespeare.
# provide an example code to train shakepeare dataset in federated learning.
# read data
import json
import os
...
class ShakeSpeare(Dataset):
    def __init__(self, train=True):
        ...
        train_clients, train_groups, train_data_temp, test_data_temp = read_data("./utility/dataset/shakespeare/train",
                                                                                 "./utility/dataset/shakespeare/test")
        self.train = train
