...
# random
python main.py --L 100 --unbalance $uv 0.1 --fairness clientfair --alpha 2 --notes u"$uv"c0.3_AS_a2_$sd --approx_optimal --alpha_loss --C 0.2 --num_clients 40 --class_ratio 0.3 0.3 0.3 --iid_type noniid noniid noniid --task_type fashion_mnist --algo_type proposed --seed $sd --cpumodel --local_epochs 1 1 1 --round_num 600 --insist
python main.py --L 100 --unbalance $uv 0.1 --fairness notfair --alpha 3 --notes u"$uv"c0.3_random_$sd --C 0.2 --num_clients 40 --class_ratio 0.3 0.3 0.3 --iid_type noniid noniid noniid --task_type fashion_mnist --algo_type random --seed $sd --cpumodel --local_epochs 1 1 1 --round_num 600 --insist
...
python main.py --L 100 --unbalance $uv 0.1 --fairness clientfair --alpha 2 --notes u"$uv"c0.3_OS_a2_$sd --optimal_sampling --alpha_loss --C 0.2 --num_clients 40 --class_ratio 0.3 0.3 0.3 --iid_type noniid noniid noniid --task_type fashion_mnist --algo_type proposed --seed $sd --cpumodel --local_epochs 1 1 1 --round_num 600 --insist
# q-Fel
...
python main.py --L 1000 --unbalance $uv 0.1 --fairness notfair --alpha 2 --equalP2 --approx_optimal --alpha_loss --notes u"$uv"c0.3_testfixed2_a3_$sd --C 0.2 --num_clients 40 --class_ratio 0.3 0.3 0.3 --iid_type noniid noniid noniid --task_type fashion_mnist --algo_type proposed --seed $sd --cpumodel --local_epochs 1 1 1 --round_num 600 --insist
