...
a=1
unbalance_value=(0.4 0.0)
dlist=(0.3) # data ratio
#C=(0.025 0.05 0.1 0.2) # active rate
C=(0.1) # active rate
task_idx="fashion_mnist2 fashion_mnist2 fashion_mnist fashion_mnist emnist shakespeare fashion_mnist"
iid="noniid noniid noniid noniid noniid noniid noniid"
client_n=120
# 最开始subset是0.5
