...
C=(1.0 0.5 0.3) # active rate
task_idx="fashion_mnist mnist fashion_mnist fashion_mnist fashion_mnist"
iid="noniid noniid noniid noniid noniid"
for uv in "${unbalance_value[@]}"; do
  for d in "${dlist[@]}"; do
    for c in "${C[@]}"; do
    for sd in "${seedlist[@]}"; do
python main.py --L 100 --fairness notfair --data_ratio $d --unbalance 0.9 $uv --alpha $ms_a --notes c"$c"u"$uv"d"$d"_msAS_a"$ms_a"_$sd --approx_optimal --C $c --num_clients 40 --class_ratio 0.3 0.3 0.3 0.3 0.3 --iid_type $iid --task_type $task_idx --algo_type proposed --seed $sd --cpumodel --local_epochs 1 1 1 1 1 --round_num 800 --insist
...
python main.py --L 100 --fairness taskfair --data_ratio $d --unbalance 0.9 $uv --alpha $a --notes u"$uv"d"$d"_AS_taskfair_a"$a"_$sd --alpha_loss --approx_optimal --C $c --num_clients 40 --class_ratio 0.3 0.3 0.3 0.3 0.3 0.3 --iid_type $iid --task_type $task_idx --algo_type proposed --seed $sd --cpumodel --local_epochs 1 1 1 1 1 --round_num 800 --insist
...
python main.py --L 100 --fairness notfair --data_ratio $d --unbalance 0.9 $uv --alpha 3 --notes u"$uv"d"$d"_random_$sd --C $c --num_clients 40 --class_ratio 0.3 0.3 0.3 0.3 0.3 0.3 --iid_type $iid --task_type $task_idx --algo_type random --seed $sd --cpumodel --local_epochs 1 1 1 1 1 --round_num 800 --insist
python main.py --L 100 --group_num 3 --unbalance 0.9 $uv --data_ratio $d --fairness notfair --alpha 3 --notes u"$uv"d"$d"_GS_a"$a"_$sd --C $c --num_clients 40 --class_ratio 0.3 0.3 0.3 0.3 0.3 0.3 --iid_type $iid --task_type $task_idx --algo_type random --seed $sd --cpumodel --local_epochs 1 1 1 1 1 --round_num 800 --insist
#python main.py --L 100 --unbalance 0.9 $uv --fairness clientfair --alpha $a --notes u"$uv"d"$d"_qFel_a"$a"_$sd --C 0.2 --num_clients 40 --class_ratio 0.3 0.3 0.3 --iid_type $iid --task_type fashion_mnist mnist emnist --algo_type random --seed $sd --cpumodel --local_epochs 1 1 1 --round_num 1500 --insist
python main.py --L 1000 --unbalance 0.9 $uv --fairness notfair --alpha $a --equalP2 --approx_optimal --alpha_loss --notes u"$uv"d"$d"_test2_a"$a"_$sd --C $c --num_clients 40 --class_ratio 0.3 0.3 0.3 0.3 0.3 0.3 --iid_type $iid --task_type $task_idx --algo_type proposed --seed $sd --cpumodel --local_epochs 1 1 1 1 1 --round_num 800 --insist
done
done
done
done
