...
python main.py --L 1 --venn_list 1.0 0.0 0.0 --client_cpu 1.0 0 0 --fairness notfair --data_ratio $d --unbalance $uv 0.2 --alpha $a --notes lessVennc"$c"uv"$uv"_random_$sd --C $c --num_clients $client_n --class_ratio 0.3 0.3 0.3 0.3 0.3 --iid_type $iid --task_type $task_idx --algo_type random --seed $sd --cpumodel --local_epochs 5 5 5 5 5 --round_num 150 --insist
